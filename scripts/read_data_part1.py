...
for person_num in range(1, 95):  # 001 to 94
...
final_df.to_csv(r"C:\Users\18645\pads-parkinsons-disease-smartwatch-dataset-1.0.0\pads-parkinsons-disease-smartwatch-dataset-1.0.0\preprocessed\movement_data1.csv", index=False)